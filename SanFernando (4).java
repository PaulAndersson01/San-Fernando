...
public class SanFernando {
    ...
    public static void inicializarDatos() {
        ...
        precioPollo.add(13.90);
        stockPollo.add(10);
        pollo.add("Filete de pechuga de pollo fresco");
        precioPollo.add(24.90);
        stockPollo.add(10);
        pollo.add("Filete de pierna de pollo sin piel ");
        precioPollo.add(22.90);
        stockPollo.add(10);
        pollo.add("Muslo de pollo fresco");
        precioPollo.add(16.50);
        stockPollo.add(10);
        pollo.add("Pierna de pollo fresco");
        precioPollo.add(17.49);
        stockPollo.add(10);
        ...
        stockPavita.add(10);
        pavita.add("Pechuga  hornenada de pavo rango (3 a 4kg)");
        precioPavita.add(25.70);
        stockPavita.add(10);
        ...
        stockCerdo.add(10);
        cerdo.add("Chicharron de Cerdo sin hueso y sin piel");
        precioCerdo.add(38.42);
        stockCerdo.add(10);
        // huevos
        ...
        stockEmbutidos.add(10);
        embutidos.add("Chorizo sabor Tocino");
        precioEmbutidos.add(16.10);
        stockEmbutidos.add(10);
        ...
        precioEmbutidos.add(17.00);
        stockEmbutidos.add(10);
        embutidos.add("Mix de Chorizo sabor Mundial");
        precioEmbutidos.add(16.10);
        stockEmbutidos.add(10);
        embutidos.add("Chorizo sabor Cabanossi");
        precioEmbutidos.add(16.10);
        stockEmbutidos.add(10);
        embutidos.add("Chorizo sabor Cebolla Caramelizada");
        precioEmbutidos.add(16.10);
        stockEmbutidos.add(10);
        embutidos.add("Chorizo Finas Hievas x400g");
        precioEmbutidos.add(14.50);
        stockEmbutidos.add(10);
        //celebridades
        ...
        stockCelebridades.add(10);
        // complementos
        complementos.add("Arroz grande costeño 5kg");
        precioComplementos.add(23.50);
        stockComplementos.add(10);
        complementos.add("Arroz pequeno costeño 1kg");
        precioComplementos.add(4.90);
        stockComplementos.add(10);
        complementos.add("Arroz mega costeño 10kg");
        ...
        stockComplementos.add(10);
        complementos.add("Aceite de Oliva extra Virgen 1L");
        precioComplementos.add(51.90);
        stockComplementos.add(10);
        complementos.add("Aceite de Oliva extra Virgen 500ml");
        precioComplementos.add(28.90);
        stockComplementos.add(10);
        complementos.add("Aceite de Oliva extra Virgen  4L");
        precioComplementos.add(167.00);
        stockComplementos.add(10);
    }
    ...
    public static void tiendaSanFernando() {
        ...
        while (opcionTienda != 12) {
            ...
            System.out.println("9.- Ofertas del dia");
            System.out.println("10.- Ayuda");
            System.out.println("11.- Ver Carrito y Pagar");
    ...
    public static void ofertasDelDia() {
        System.out.println("================================================================");
        System.out.println("           *** OFERTAS DEL DIA - SAN FERNANDO *** ");
        System.out.println("================================================================");
        ArrayList<String>[]  listas  = new ArrayList[]{pollo, pavita, cerdo, huevos, congelados, embutidos, celebridades, complementos};
        ArrayList<Double>[]  precios = new ArrayList[]{precioPollo, precioPavita, precioCerdo, precioHuevos, precioCongelados, precioEmbutidos, precioCelebridades, precioComplementos};
        ArrayList<Integer>[] stocks  = new ArrayList[]{stockPollo, stockPavita, stockCerdo, stockHuevos, stockCongelados, stockEmbutidos, stockCelebridades, stockComplementos};
        ArrayList<Integer>[] carritos = new ArrayList[]{carritoPollo, carritoPavita, carritoCerdo, carritoHuevos, carritoCongelados, carritoEmbutidos, carritoCelebridades, carritoComplementos};
        String[] cats = {"Pollo","Pavita","Cerdo","Huevos","Congelados","Embutidos","Celebridades","Complementos"};

        ArrayList<String> todosNombres = new ArrayList<>();
        ArrayList<Double> todosPrecios = new ArrayList<>();
        ArrayList<String> todasCats   = new ArrayList<>();
        ArrayList<Integer> mapaCategoria = new ArrayList<>();
        ArrayList<Integer> mapaPosicionOriginal = new ArrayList<>();

        for (int c = 0; c < listas.length; c++) {
            for (int i = 0; i < listas[c].size(); i++) {
                todosNombres.add(listas[c].get(i));
                todosPrecios.add(precios[c].get(i));
                todasCats.add(cats[c]);
                mapaCategoria.add(c);
                mapaPosicionOriginal.add(i);
            }
        }
        ...
        while (indices.size() < 5) {
            int idx = rand.nextInt(todosNombres.size());
            if (!indices.contains(idx)) indices.add(idx);
        }

        ArrayList<String> ofNombres  = new ArrayList<>();
        ArrayList<Double> ofPrecios  = new ArrayList<>();
        ArrayList<Integer> ofDescs   = new ArrayList<>();
        ArrayList<String> ofCats     = new ArrayList<>();
        ArrayList<Integer> ofCatIdx  = new ArrayList<>();
        ArrayList<Integer> ofProdIdx = new ArrayList<>();

        for (int idx : indices) {
            int desc = rand.nextInt(21); // Descuento aleatorio entre 0 y 20%
            double precioOferta = Math.round(todosPrecios.get(idx) * (1 - desc / 100.0) * 100.0) / 100.0;
            ofNombres.add(todosNombres.get(idx));
            ofPrecios.add(precioOferta);
            ofDescs.add(desc);
            ofCats.add(todasCats.get(idx));
            ofCatIdx.add(mapaCategoria.get(idx));
            ofProdIdx.add(mapaPosicionOriginal.get(idx));
        }

        List<Integer> indOrd = new ArrayList<>();
        for (int i = 0; i < 5; i++) indOrd.add(i);
        indOrd = indOrd.stream()
                .sorted((a, b) -> Double.compare(ofPrecios.get(a), ofPrecios.get(b)))
                .collect(Collectors.toList());
        OptionalDouble precioMin = ofPrecios.stream().mapToDouble(Double::doubleValue).min();
        OptionalDouble precioMax = ofPrecios.stream().mapToDouble(Double::doubleValue).max();
        System.out.println("  Ordenado de menor a mayor precio");
        System.out.println("----------------------------------------------------------------");
        int numerador = 1;
        for (int i : indOrd) {
            String tag = "";
            if (precioMin.isPresent() && ofPrecios.get(i) == precioMin.getAsDouble()) tag = "  << MAS BARATO";
            if (precioMax.isPresent() && ofPrecios.get(i) == precioMax.getAsDouble()) tag = "  << MAS CARO";

            System.out.println("  [" + numerador + "] Categoria : " + ofCats.get(i));
            System.out.println("      Producto  : " + ofNombres.get(i));
            System.out.println("      Stock Disp: " + stocks[ofCatIdx.get(i)].get(ofProdIdx.get(i)));
            if (ofDescs.get(i) > 0) {
                System.out.println("      Descuento : " + ofDescs.get(i) + "%  ->  Precio Oferta: S/ " + ofPrecios.get(i) + tag);
            } else {
                System.out.println("      Precio    : S/ " + ofPrecios.get(i) + "  (sin descuento)" + tag);
            }
            System.out.println("----------------------------------------------------------------");
            numerador++;
        }
        ...
        System.out.println("¿Desea comprar alguna de estas ofertas? (S/N):");
        leer.nextLine();
        String comprar = leer.nextLine();
        if (comprar.equalsIgnoreCase("S")) {
            System.out.println("Ingrese el número de la oferta que desea (1-5):");
            int opcionOf = leer.nextInt();
            leer.nextLine();
            if (opcionOf >= 1 && opcionOf <= 5) {
                int idxSeleccionado = indOrd.get(opcionOf - 1);
                int catActual = ofCatIdx.get(idxSeleccionado);
                int prodActual = ofProdIdx.get(idxSeleccionado);
                System.out.println("¿Cuántas unidades de '" + ofNombres.get(idxSeleccionado) + "' desea agregar?");
                int cant = leer.nextInt();
                leer.nextLine();
                int stockDisponible = stocks[catActual].get(prodActual);
                if (cant > 0 && cant <= stockDisponible) {
                    precios[catActual].set(prodActual, ofPrecios.get(idxSeleccionado));
                    carritos[catActual].set(prodActual, carritos[catActual].get(prodActual) + cant);
                    stocks[catActual].set(prodActual, stockDisponible - cant);

                    System.out.println("¡Éxito! " + cant + " unidad(es) agregada(s) al carrito con el precio de oferta.");
                } else {
                    System.out.println("Error: Cantidad no válida o supera el stock disponible (" + stockDisponible + ").");
                }
            } else {
    ...
    public static void menuAyuda() {
        ...
        while (opcion != 5) {
            System.out.println("================================================================");
            System.out.println("             CENTRO DE AYUDA - SAN FERNANDO                    ");
            System.out.println("================================================================");
            System.out.println("  1.- Buscar producto por nombre");
            System.out.println("  2.- Registrar un Reclamo");
            System.out.println("  3.- Enviar una Sugerencia");
            System.out.println("  4.- Preguntas Frecuentes (FAQ)");
            System.out.println("  5.- Volver a la Tienda");
            System.out.println("================================================================");
            System.out.println("Seleccione una opcion:");
            opcion = leer.nextInt();
            leer.nextLine();
    ...
    public static void ayudaBuscarProducto() {
        System.out.println("--- Buscar Producto ---");
        System.out.println("Ingrese el nombre o parte del nombre del producto:");
        String busq = leer.nextLine().toLowerCase();
        boolean encontrado = false;
        ArrayList<String>[] todasListas   = new ArrayList[]{pollo, pavita, cerdo, huevos, congelados, embutidos, celebridades, complementos};
        ArrayList<Double>[] todosPrecios  = new ArrayList[]{precioPollo, precioPavita, precioCerdo, precioHuevos, precioCongelados, precioEmbutidos, precioCelebridades, precioComplementos};
        ArrayList<Integer>[] todosStocks  = new ArrayList[]{stockPollo, stockPavita, stockCerdo, stockHuevos, stockCongelados, stockEmbutidos, stockCelebridades, stockComplementos};
        String[] categorias = {"Pollo","Pavita","Cerdo","Huevos","Congelados","Embutidos","Celebridades","Complementos"};
        for (int c = 0; c < todasListas.length; c++) {
            for (int i = 0; i < todasListas[c].size(); i++) {
                String producto = todasListas[c].get(i).toLowerCase();
                if (producto.contains(busq)) {
                    System.out.println("  [" + categorias[c] + "] pos " + i + "  -  "
                            + todasListas[c].get(i) + "  -  S/ " + todosPrecios[c].get(i)
                            + "  -  Stock: " + todosStocks[c].get(i));
                    encontrado = true;
                }
            }
        }
    ...
    public static void ayudaReclamo() {
        LocalDateTime ahora = LocalDateTime.now();
        int numeroAleatorio = new Random().nextInt(9000) + 1000;
        String nroRec = "REC-" + ahora.format(DateTimeFormatter.ofPattern("yyyyMMdd"))
                + "-" + numeroAleatorio;
        System.out.println("================================================================");
        System.out.println("              LIBRO DE RECLAMACIONES                           ");
        System.out.println("================================================================");
        System.out.println("  N Reclamo : " + nroRec);
        System.out.println("  Fecha     : " + ahora.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")));
        System.out.println("  Cliente   : " + usuarioActivo);
        System.out.println("----------------------------------------------------------------");
        System.out.println("  Tipo de problema:");
        System.out.println("  1.- Producto en mal estado");
        System.out.println("  2.- Producto incorrecto");
        System.out.println("  3.- Demora en la atencion");
        System.out.println("  4.- Cobro incorrecto");
        ...
        switch (tipo) {
            case 1:
                tipoTxt = "Producto en mal estado";
                break;
            case 2:
                tipoTxt = "Producto incorrecto";
                break;
            case 3:
                tipoTxt = "Demora en la atencion";
                break;
            case 4:
                tipoTxt = "Cobro incorrecto";
                break;
            case 5:
                tipoTxt = "Otro";
                break;
            default:
                tipoTxt = "No especificado";
                break;
        }
        System.out.println("Describa su reclamo:");
        String desc = leer.nextLine();
        System.out.println("----------------------------------------------------------------");
        System.out.println("  Reclamo registrado: " + nroRec);
        System.out.println("  Tipo             : " + tipoTxt);
        System.out.println("  Detalle          : " + desc);
        System.out.println("  Le responderemos en 15 dias habiles.");
        System.out.println("  Linea gratuita   : 0800-00-472");
        System.out.println("================================================================");
        System.out.println("Presione ENTER para continuar...");
        leer.nextLine();
    }
    public static void ayudaSugerencia() {
        System.out.println("================================================================");
        System.out.println("                 BUZON DE SUGERENCIAS                          ");
        System.out.println("================================================================");
        System.out.println("  1.- Calidad de productos");
        System.out.println("  2.- Variedad del catalogo");
        System.out.println("  3.- Precios y ofertas");
        System.out.println("  4.- Atencion al cliente");
        System.out.println("  5.- Otra sugerencia");
        System.out.println("Seleccione el area:");
        int area = leer.nextInt(); leer.nextLine();
        String areaTxt;
        switch (area) {
            case 1:
                areaTxt = "Calidad de productos";
                break;
            case 2:
                areaTxt = "Variedad del catalogo";
                break;
            case 3:
                areaTxt = "Precios y ofertas";
                break;
            case 4:
                areaTxt = "Atencion al cliente";
                break;
            case 5:
                areaTxt = "Otra sugerencia";
                break;
            default:
                areaTxt = "General";
                break;
        }
        System.out.println("Escriba su sugerencia:");
        String sug = leer.nextLine();
        System.out.println("Califique su experiencia (1=Muy mala / 5=Excelente):");
        int cal = leer.nextInt(); leer.nextLine();
        cal = Math.max(1, Math.min(5, cal));
        System.out.println("----------------------------------------------------------------");
        System.out.println("  Area        : " + areaTxt);
        System.out.println("  Sugerencia  : " + sug);
        System.out.println("  Calificacion: " + "*".repeat(cal) + " (" + cal + "/5)");
        System.out.println("  Gracias por su opinion, " + usuarioActivo + "!");
        System.out.println("================================================================");
        System.out.println("Presione ENTER para continuar...");
        leer.nextLine();
    }
    public static void ayudaFAQ() {
        boolean salir = false;
        while (!salir) {
            System.out.println("================================================================");
            System.out.println("             PREGUNTAS FRECUENTES (FAQ)                        ");
            System.out.println("================================================================");
            System.out.println("  1.- Como realizo mi pedido?");
            System.out.println("  2.- Cuales son los metodos de pago?");
            System.out.println("  3.- Puedo devolver un producto?");
            System.out.println("  4.- Donde recojo mi pedido?");
            System.out.println("  5.- Volver al menu de Ayuda");
            System.out.println("Seleccione:");
            int opcion = leer.nextInt(); leer.nextLine();
            System.out.println("----------------------------------------------------------------");
            switch (opcion) {
                case 1:
                    System.out.println("  1) Elija categoria y producto en la tienda.");
                    System.out.println("  2) Agregue la cantidad al carrito.");
                    System.out.println("  3) Opcion 9 'Ver Carrito y Pagar'.");
                    System.out.println("  4) Pague y elija sucursal. Se genera su boleta .txt");
                    break;
                case 2:
                    System.out.println("  - Efectivo: ingrese el monto y reciba su vuelto.");
                    System.out.println("  - Tarjeta : Visa o Mastercard (16 digitos + CVV).");
                    break;
                case 3:
                    System.out.println("  - Productos en mal estado: devolucion inmediata.");
                    System.out.println("  - Presente su boleta y el producto en su empaque.");
                    System.out.println("  - Use la opcion Reclamos del menu de Ayuda.");
                    break;
                case 4:
                    System.out.println("  Sucursales: Puno, Juliaca, Arequipa, Lima, Moquegua.");
                    System.out.println("  Horario: Lunes a Sabado de 8am a 8pm.");
                    System.out.println("  Presente su N de pedido en caja (ej: SF-XXXX-XXXXXX).");
                    break;
                case 5:
                    salir = true;
                    System.out.println("Regresando al menu de Ayuda...");
                    break;
                default:
                    System.out.println("  Opcion no valida.");
                    break;
    ...
    public static void generarBoleta(double total, double subtotal, double igv, double montoEntregado, String metodoPago, String sucursal) {
        ...
        int numPedido   = new Random().nextInt(900000) + 100000;
        String nroPedido = "SF-" + ahora.format(DateTimeFormatter.ofPattern("yyyyMMdd")) + "-" + numPedido;
        System.out.println("================================");
        System.out.println("       BOLETA DE VENTA          ");
        System.out.println("         SAN-FERNANDO        s   ");
        System.out.println("================================");
        System.out.println("RUC            : " + ruc);
        System.out.println("N Pedido       : " + nroPedido);
        ...
        System.out.println("    LA BUENA FAMILIA     ");
        System.out.println("================================");
        String nombreArchivo = "boleta_" + nroPedido + ".txt";
        try (FileWriter escritor = new FileWriter(nombreArchivo)) {
            escritor.write("================================\n");
            escritor.write("       BOLETA DE VENTA          \n");
            escritor.write("          SAN-FERNANDO          \n");
            escritor.write("================================\n");
            escritor.write("RUC            : " + ruc + "\n");
            escritor.write("N Pedido       : " + nroPedido + "\n");
            escritor.write("Fecha          : " + fecha + "\n");
            escritor.write("Hora           : " + hora + "\n");
            escritor.write("--------------------------------\n");
            escritor.write("Cliente        : " + usuarioActivo + "\n");
            escritor.write("Metodo de Pago : " + metodoPago + "\n");
            escritor.write("Local de Recojo: " + sucursal + "\n");
            escritor.write("--------------------------------\n");
            escritor.write("Subtotal       : S/ " + subtotal + "\n");
            escritor.write("IGV (18%)      : S/ " + igv + "\n");
            escritor.write("TOTAL          : S/ " + total + "\n");
            escritor.write("Monto Entregado: S/ " + montoEntregado + "\n");
            escritor.write("Cambio         : S/ " + vuelto + "\n");
            escritor.write("================================\n");
            escritor.write("  Gracias por comprar en\n");
            escritor.write("      SAN FERNANDO\n");
            escritor.write("    LA BUENA FAMILIA\n");
            escritor.write("================================\n");
